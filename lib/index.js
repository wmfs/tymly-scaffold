...
module.exports = class Scaffold {
  ...
  _destFile (filename, componentDirName) {
    ...
    if (componentDirName) {
      fullPath = path.join(fullPath, 'components', componentDirName)
    }
  ...
  _getComponentPath (componentDirName) {
    return path.join(this.base, this.blueprintName, 'components', componentDirName)
  }

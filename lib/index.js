...
module.exports = class Scaffold {
  ...
  makeCategory (options) {
    const templateFile = path.join('categories', 'category.json.ejs')
    const categoryFile = path.join('categories', `${this._safeFilename(options.name)}.json`)

    this._templateCopy(templateFile, categoryFile, options)
